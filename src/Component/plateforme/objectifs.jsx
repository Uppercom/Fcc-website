                        ...
                        <div className="btContent">
                            <div className="bt_bb_wrapper">
                                ...
                                <section className="bt_bb_section bt_bb_top_spacing_small bt_bb_bottom_spacing_small bt_bb_color_scheme_1 bt_bb_layout_boxed_700 bt_bb_vertical_align_top bt_bb_background_image bt_bb_parallax">
                                    <div className="bt_bb_port">
                                        <div className="bt_bb_cell">
                                            <h2 style={{fontWeight: '900', fontSize: '35px'}} class="b__nudge--bottom text--center text--normal">Nos objectifs</h2>
                                            <div class="text--center">
                                                <p>Le FCC a pour ambition de conquérir le pouvoir politique pour mener à bien sa politique du pouvoir. Ce n’est pas conquérir le pouvoir pour le pouvoir, mais pour un objectif bien précis : exercer le pouvoir en tirant les gens vers le haut plutôt qu’en les écrasant, sortir les Congolais des conditions qui ne leur permette pas d’aller de l’avant. Le FCC a conscience de l’urgence et de la complexité des problèmes à résoudre. </p>
                                                <p>Les Congolais sont tombés dans la désillusion. Leurs attentes ne reçoivent plus de réponses, comme si aucune oreille ne saisit leur cri. Il nous faut leur redonner confiance dans la politique, à travers l’efficacité de notre action. Le FCC promet d’être proches des réalités des Congolais, à l’écoute de leurs préoccupations, et chaque fois qu’il trouvera une voix de sortie, d’en parler aux concernés, d’en expliquer les choix nécessaires et les modalités à toute action.
                                                    Le FCC prône aujourd’hui une nouvelle lecture de la démocratie, la vraie démocratie à l’œuvre – non pas la démocratie entendue comme un cadeau tombé du ciel, ni comme un butin à se répartir entre groupes d’intérêts, mais une démocratie du mérite, fruit du travail de chacun. Il en résultait non seulement un changement dans les conditions de vie matérielles, mais aussi un sentiment accru de dignité chez les individus et au sein des communautés, un lien entre des gens qu’hier encore tout semblait séparer. Et le FCC s’en tiendra simplement à cet objectif car tout se prépare à l’avance, est évalué et la gouvernance future prohibe une navigation à vue.</p>
                                            </div>
                                        </div>
                                    </div>
                                </section>
